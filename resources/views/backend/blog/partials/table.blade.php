<tr>
    <td>{{++$key}}</td>
    <td>{{ Str::limit(ucfirst($blog->title), 47) }}</td>
    @if (isset($blog->image))
        <td><img src="{{ asset(str_replace('\\', '/', $blog->image)) }}" class="img-circle width-1" alt="blog_image" width="82" height="48"></td>
    @else
        <td>
            <img src="{{ asset('images/noimage.png') }}" class="img-circle width-1" alt="blog_image" width="70" height="70">
        </td>
    @endif
    <td>
